...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<%=request.getContextPath()%>">taches public</a></li>
 ...
 <div class="row">
	<div class="col-sm-8">
        <div class="row">
            ...
            <div class="col-sm-4">
                <h3> <form method="post" name="en attendant"><button type="submit" name="ok" value="ok" class="btn btn-success">ajouter</button></form></h3>
